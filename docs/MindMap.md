...
├── 05-database/                                 # 数据库相关
    ├── 01-transaction-isolation/                # 事务隔离级别 ✅
    │   ├── doc_01.md                            # 事务ACID、四种隔离级别、MVCC
    │   ├── demo/                                # 代码示例
    │   │   ├── README.md                        # 运行说明
    │   │   └── TransactionIsolationDemo.java    # 隔离级别并发问题演示
    │   ├── test_01.md                           # 自测题（7道题，100分）
    │   └── note_template.md                     # 学习笔记模板
    │
    └── 02-index-optimization/                   # 索引设计与优化 ✅
        ├── doc_01.md                            # 索引类型、设计原则、失效场景、EXPLAIN
        ├── demo/                                # 代码示例
        │   ├── README.md                        # 运行说明
...
> 项目已经初始化好了，包含一些轻型依赖，不包含数据库依赖。 你可以屏蔽或者删除pom.xml来获取一个纯净的项目👍